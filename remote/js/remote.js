...
break;case Key.Q:case Key.EQUALS:isValidKey=true;thisObject.isDown=false;remote.sendRequest(RequestType.VOLUME_UP);break;case Key.W:case Key.MINUS:isValidKey=true;thisObject.isDown=false;remote.sendRequest(RequestType.VOLUME_DOWN);break;}
if(isValidKey==true)
...
{var params={action:"skipnext"};xbmcSocket.send("Input.ExecuteAction",params);});thisObject.bindFastClick($("#mute"),function(event)
