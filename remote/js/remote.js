...
{thisObject.hideShutDownPanel();thisObject.sendRequest(RequestType.SHUTDOWN);});thisObject.bindFastClick($("#sendTextDataButton"),function(event)
...
{var obj=JSON.parse(data);console.log("done");if(obj.result.length>0)
{for(var i=0;i<obj.result.length;i++)
{var params={playerid:obj.result[i].playerid};xbmcSocket.send("Player.PlayPause",params);}}});break;case RequestType.INFO:xbmcSocket.send("Input.Info");break;case RequestType.CONTEXT_MENU:xbmcSocket.send("Input.ContextMenu");break;case RequestType.SELECT:xbmcSocket.send("Input.Select");break;case RequestType.BACK:xbmcSocket.send("Input.Back");break;case RequestType.MUTE:params={action:"mute"};xbmcSocket.send("Input.ExecuteAction",params);break;case RequestType.HOME:xbmcSocket.send("Input.Home");break;case RequestType.SHOW_OSD:xbmcSocket.send("Input.ShowOSD");break;case RequestType.MOVE_LEFT:xbmcSocket.send("Input.Left");break;case RequestType.SEEK_BACK:params={action:"stepback"};xbmcSocket.send("Input.ExecuteAction",params);break;case RequestType.MOVE_RIGHT:xbmcSocket.send("Input.Right");break;case RequestType.SEEK_FRONT:params={action:"stepforward"};xbmcSocket.send("Input.ExecuteAction",params);break;case RequestType.MOVE_UP:xbmcSocket.send("Input.Up");break;case RequestType.MOVE_DOWN:xbmcSocket.send("Input.Down");break;case RequestType.VOLUME_UP:params={action:"volumeup"};xbmcSocket.send("Input.ExecuteAction",params);break;case RequestType.VOLUME_DOWN:params={action:"volumedown"};xbmcSocket.send("Input.ExecuteAction",params);break;case RequestType.SHUTDOWN:xbmcSocket.send("System.Shutdown");break;case RequestType.RESTART:xbmcSocket.send("System.Reboot");break;case RequestType.UPDATE_LIBRARY:xbmcSocket.send("VideoLibrary.Scan");break;}};this.showShutDownPanel=function()
